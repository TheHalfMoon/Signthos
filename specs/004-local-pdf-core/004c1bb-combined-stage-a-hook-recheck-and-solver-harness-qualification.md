...
The transport-helper identities are provenance-bound by `github:issue-comment:5611226214` to the retained canonical 004C1AI rootfs inventory. Both retained Replay A/B inventories are exactly `7969350` bytes, SHA-256 `f5362f12e52f0ef7d4fa42bca401be0c3cf99a2bc9962a085fd6b4eb4d6e658d`, and byte-identical. Selecting exactly the JSONL rows whose `path` is `usr/bin/cat` or `usr/bin/rm` yields the same rows in both inventories. With one trailing LF, the `cat` row SHA-256 is `c6d397d4646fbda4894c13b2502c07c89022b0b924bbef6999836f6a335277ac`; the `rm` row SHA-256 is `4c72449489420defbaa8b9ec795c8fbe61d829c8ae233d3f2834f1f26ae28e6b`. No helper identity is inferred from an unbound local file.
...
2. verify the bound `sha256sum`, `stat`, `cat`, `tar`, and `rm` helper identities; receive stdin into a temporary tmpfs file; require exactly `204769280` raw bytes and SHA-256 `f7fd9486...` **before extraction**; then extract that verified file and delete it before continuing;
...
```text
GUEST_SCRIPT_BYTES = 8931
GUEST_SCRIPT_SHA256 = de3d1add92899dd5fff4ad7f395929fcd27f66d15ddd03285d06c439aa00298a
GUEST_SCRIPT_TRAILING_LF = TRUE
```

The exact script bytes are represented as one JSON string below. JSON-decode the string value; do not append or remove bytes. The decoded value must be exactly 8,931 UTF-8 bytes with the SHA-256 above.
...
The Docker envelope preserves the canonical isolation posture: `--pull=never`, explicit `linux/amd64`, `--network none`, read-only rootfs, all capabilities dropped, `no-new-privileges`, bounded pids/memory/cpu, isolated bounded tmpfs, four execution-control environment overrides, explicit `/bin/sh` entrypoint, no bind/volume/repository/host mounts, and stdin transport only. To make the raw transport identity itself fail-closed, the tmpfs bound is increased from the earlier 384 MiB envelope to 416 MiB while the container memory cap remains 512 MiB. The exact raw-plus-extracted regular-file peak is 409,518,839 bytes; 416 MiB provides 26,688,777 bytes of tmpfs headroom. No other resource or isolation control is relaxed.

```text
DOCKER_ARGC = 35
DOCKER_ARGV_JSON_BYTES = 9897
DOCKER_ARGV_SHA256 = ddf10251d79b8adc7117db36813b792043eee9a2e23f9cacc10e0c20ee6ba038
```
...
```text
004C1BB_CONTRACT_JSON_BYTES = 2733
004C1BB_CONTRACT_JSON_SHA256 = 64b89b4cdf463d73deedd3e01eb69a6058ccfb51d4a0f4a89fe2489c7580351a
```

```json
{"awTransport":{"bytes":204769280,"rawGateBeforeExtraction":true,"sha256":"f7fd9486a7eadcf82fc5e7f66c166c3de757ff5c108a32aab2bf17cccfbd4755"},"canonicalBase":"eb1f93515d8aa2f1d312ec2ca8bb896ad0f039a3","containment":{"entrypoint":"/bin/sh","hostMounts":0,"memory":"512m","network":"none","platform":"linux/amd64","pull":"never","readOnlyRootfs":true,"tmpfs":"/tmp/signthos-apt:rw,nosuid,nodev,noexec,size=416m,mode=0755"},"dockerArgv":{"argc":35,"jsonBytes":9897,"sha256":"ddf10251d79b8adc7117db36813b792043eee9a2e23f9cacc10e0c20ee6ba038"},"evidenceMembers":["bb-after.tsv","bb-apt-identity.tsv","bb-apt-version.stderr","bb-apt-version.stdout","bb-apt.exit","bb-apt.stderr","bb-apt.stdout","bb-before.tsv","bb-helpers.tsv","bb-hook.exit","bb-hook.stderr","bb-hook.stdout","bb-process.txt","bb-substrate.stderr","bb-substrate.stdout"],"guestScript":{"bytes":8931,"sha256":"de3d1add92899dd5fff4ad7f395929fcd27f66d15ddd03285d06c439aa00298a","trailingLf":true},"hookRecheck":{"argc":32,"argvSha256":"c56c77e8d564c9c9d0f89342dc96d7aedeabc527107628d24ec4aa30bbc2a372","immediatelyBeforeStageA":true,"requiredExit":0,"requiredStderrBytes":0,"requiredStdoutBytes":0},"inputInventory":{"bytes":3523,"lines":27,"sha256":"61737063acecabc925876810e67f9476020ca161050083c088337e835e14ee66"},"observer":{"survivingProcCommReadFailureExit":70,"vanishedProcCommSkippable":true},"schema":"signthos.004c1bb.combined-stage-a-harness.v2","selectedImage":{"configDigest":"sha256:6c08d5b78c2a32982d454cd13735f2370941c81040fccc667ac3c7f8482928d0","platform":"linux/amd64","ref":"docker.io/emscripten/emsdk@sha256:c64f3cadcdff49ae65eadd815a425680a3f4c038b8fd49fe639c12e651d9c0a3"},"stageA":{"argc":42,"argvSha256":"dceeccc5096bbc9eb0c661b93be5a5091f459a2ffaeed808b4bebb212ebff96b"},"successPreconditions":{"afterInventorySha256":"61737063acecabc925876810e67f9476020ca161050083c088337e835e14ee66","beforeInventorySha256":"61737063acecabc925876810e67f9476020ca161050083c088337e835e14ee66","machine":"x86_64","rodetePredicate":false},"transportHelperProvenance":{"canonicalInventoryBytes":7969350,"canonicalInventorySha256":"f5362f12e52f0ef7d4fa42bca401be0c3cf99a2bc9962a085fd6b4eb4d6e658d","catRowSha256":"c6d397d4646fbda4894c13b2502c07c89022b0b924bbef6999836f6a335277ac","replayAReplayBByteEqual":true,"rmRowSha256":"4c72449489420defbaa8b9ec795c8fbe61d829c8ae233d3f2834f1f26ae28e6b","source":"github:issue-comment:5611226214"},"transportHelpers":{"/usr/bin/cat":"210ffa7daedb3ef6e9230d391e9a10043699ba81080ebf40c6de70ed77e278ba","/usr/bin/rm":"7477c0f734a465a39a4fe40f6a9bb9d7431827e0a1d799ad1f25855b5dc63682"},"transportPeak":{"extractedRegularBytes":204749559,"headroomBytes":26688777,"peakFileBytes":409518839,"rawBytes":204769280,"tmpfsBytes":436207616}}
```

## 10. Qualification result

```text
AW_RAW_TRANSPORT_PRE_EXTRACTION_IDENTITY_GATE = PASS_STATIC
