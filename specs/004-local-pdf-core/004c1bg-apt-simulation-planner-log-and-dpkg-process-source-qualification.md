...
004C1BG_CANDIDATE_DOCKER_ARGV_JSON_BYTES = 10224
004C1BG_CANDIDATE_DOCKER_ARGV_SHA256 = 060b70b35ad915eb9b0e0e25b950a474624e4a52730add84bf5ddfc00806f179
...
6. `bb-eipp.log.xz` present as a separately preserved 16th evidence member with its observed byte identity recorded, never silently discarded;
7. process observer contains no `dpkg` process and no new unexpected executable process;
