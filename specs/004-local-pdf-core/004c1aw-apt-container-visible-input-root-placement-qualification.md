...
### Complete exact guest command

After the explicit Docker entrypoint, the image arguments are exactly `-ceu` followed by the complete script below. The script is UTF-8 with the exact identity:
