...
Establish the canonical product thesis, licensing/provenance boundary, competitor benchmark, architecture and dependency-ordered execution roadmap before any upstream product source is imported.
...
- Use Tauri 2 as the desktop/mobile shell hypothesis.
...
- `ROADMAP.md` defines dependency-ordered bounded successor specifications.
...
- an independent substantive review evaluates architecture, licensing assumptions, roadmap decomposition and missing competitor capabilities.
- required review findings are reconciled on the exact candidate head.
