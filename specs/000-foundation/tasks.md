...
These do not prevent Foundation 000 from documenting the architecture, but they prevent affected source imports:
...
- `B002` Final Signthos repository license decision must be made before the first derived/imported product-code release.
